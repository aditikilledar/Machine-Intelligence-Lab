...
class HMM:
    ...
    def viterbi_algorithm(self, seq):
        ...
        self.states_dict = {val: keys for keys, val in self.states_dict.items()}
        # find pred for each state
        hidden_states_sequence = [self.states_dict[i] for i in states]
