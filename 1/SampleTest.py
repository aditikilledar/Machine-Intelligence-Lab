...
# had to convert indenation to tab :)
...
def test_case():
	...
	try:
		# 
		# print(mymodule.create_numpy_ones_array({12,1}))
		#
	...
	try:
		# 
		# print(mymodule.create_identity_numpy_array(5))
	...
	try:
		# 
		# mymodule.matrix_cofactor(np.array([[11,23,34],[56,32,23],[23,212,45]]))
		# 
	...
	try:
		...
		print("Test Case 8 for the function fill_with_group_average FAILEDddd")
